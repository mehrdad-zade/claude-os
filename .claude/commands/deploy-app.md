...
3. Navigate to the IaC directory and run the apply command:
...
5. On success, update `.claude/memories/infrastructure-state.json` with the new service states and deployment timestamp.
